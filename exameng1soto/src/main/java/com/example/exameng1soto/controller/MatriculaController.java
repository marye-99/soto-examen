...
public class MatriculaController {
	...
	@GetMapping("/{id}")
	public ResponseEntity<Matricula> getPacienteId(@PathVariable Long id) {
		try {
	...
	@DeleteMapping("/{id}")
	public ResponseEntity<Matricula> delPaciente(@PathVariable Long id) {
		try {
			service.delete(id);
	...
	@PutMapping("/{id}")
	public ResponseEntity<Matricula> updatePaciente(@PathVariable Long id, @Valid @RequestBody Matricula ma) {
